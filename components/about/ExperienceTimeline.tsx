  ...
  const experiences = [
    {
      ...
      type: 'Full-time',
      description: 'Building conversational AI voice bots and modernizing enterprise platforms on the AI Team INCITE, using Claude and other LLMs across the delivery lifecycle.',
      achievements: [
        "Developed AI-powered voice bots for Albertsons' Contact Center with Google CCAI, serving 2,200+ stores and turning rule-based workflows into conversational AI",
        'Leveraged Claude and other LLMs for prompt engineering, solution design, code generation, debugging, and documentation — accelerating delivery',
        "Modernizing Albertsons' internal employee platform via migration to Next.js and TypeScript for scalability, maintainability, and performance",
        'Designed and developed APIs and backend services powering voice automation systems and enterprise applications',
      ],
      technologies: ['Google CCAI', 'Claude', 'LLMs', 'Next.js', 'TypeScript', 'Prompt Engineering'],
    ...
    },
    {
      ...
      type: 'Full-time',
      description: 'Working with the AI Team INCITE (Innovation & Continuous Improvement Team). Architected the Full Stack AI Document Analyzer & Reviewer for Philtech Finance end-to-end.',
      achievements: [
        'Led and architected the Full Stack AI Document Analyzer & Reviewer for Philtech Finance end-to-end',
        'Built the UI from scratch in Next.js, TypeScript, and Tailwind CSS — analytics dashboard, invoice page, and four workflow modules',
        'Developed 14 FastAPI endpoints with SQLAlchemy ORM, Pydantic, Cloud SQL (PostgreSQL), and Google Cloud Storage',
        'Dockerized frontend and backend and deployed on Google Kubernetes Engine (GKE) for high availability and scalability',
        'Built GitHub Actions CI/CD pipelines and managed the system on GCP with Kubernetes-based scaling, monitoring, and logging',
      ],
      technologies: ['Next.js', 'TypeScript', 'FastAPI', 'PostgreSQL', 'Docker', 'GKE', 'GitHub Actions', 'GCP'],
